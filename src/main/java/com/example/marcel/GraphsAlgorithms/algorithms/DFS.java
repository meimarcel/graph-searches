...
public class DFS {
    ...
    private Node end;
    private Stack<Node> limits;
    private Graph graph;
    private static Integer pathX[] = {1, 0, -1, 0};
    private static Integer pathY[] = {0, 1, 0, -1};

    public DFS() {
    }

    public DFS(Integer[][] grid, Node initial, Node end, Graph graph) {
        this.grid = grid;
        this.initial = initial;
        this.end = end;
        this.limits = new Stack<>();
        this.graph = graph;
    }
    ...
    public Stack<Node> getLimits() {
        return limits;
    }

    public void setLimits(Stack<Node> limits) {
        this.limits = limits;
    }
